...
import { WorkspaceMember, getWorkspaceMembers, inviteMember, updateMemberRole, removeMember } from "../services/memberService";
...
export function MemberManagementModal({ isOpen, onClose, workspaceId }: MemberManagementModalProps) {
  const { user } = useAuth();
  ...
  return (
    <EditModal isOpen={isOpen} onClose={onClose} title="Manage Members">
              ...
              {members.map((member) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 sm:justify-end">
                    <select
                      value={member.role}
                      onChange={(e) => handleRoleChange(member._id, e.target.value as "Owner" | "Admin" | "Member")}
